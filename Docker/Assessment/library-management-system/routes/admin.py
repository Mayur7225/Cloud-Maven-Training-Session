...
import Models.dao_instance as dao_instance
...
book_manager = BookManager(dao_instance.dao)
user_manager = UserManager(dao_instance.dao)
admin_manager = AdminManager(dao_instance.dao)
